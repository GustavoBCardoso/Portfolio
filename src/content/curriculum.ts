...
export const courses: Course[] = [
  ...
  },
  {
    ...
    period: 6,
    status: "current",
    title: { pt: "Aprofundando C#/.NET", en: "Deepening C#/.NET" },
    org: { pt: "Estudo contínuo", en: "Self-study" },
    dates: "2026 –",
    syllabus: {
      pt: [
        "Aprofundando conhecimentos em C#/.NET.",
        "Competências em foco: APIs REST, RabbitMQ, arquitetura orientada a eventos, Clean Architecture e SOLID.",
      ],
      en: [
        "Deepening my knowledge of C#/.NET.",
        "Skills in focus: REST APIs, RabbitMQ, event-driven architecture, Clean Architecture and SOLID.",
      ],
    },
    requires: ["BCK503"],
  },
  {
    ...
    period: 6,
    status: "next",
    title: { pt: "Uma vaga com foco em back-end", en: "A back-end-focused role" },
    org: { pt: "Sua equipe?", en: "Your team?" },
    dates: "—",
    syllabus: {
      pt: [
        "É a disciplina que falta na grade.",
        "Busco uma posição pleno, full-stack ou com foco em back-end, para trabalhar com APIs, dados e integrações e seguir aprendendo com o time.",
      ],
      en: [
        "It's the course still missing from the map.",
        "I'm looking for a mid-level role, full-stack or back-end focused, working on APIs, data and integrations and learning alongside the team.",
      ],
    },
